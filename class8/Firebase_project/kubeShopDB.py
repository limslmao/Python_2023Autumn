...
display_text, display_price= getProductInfo("01") # 改這裡
...
p1namelabel = Label(root, text=display_text, font=('Inter', 11), fg='#000000') # 改這裡
p1pricelabel = Label(root, text=display_price, font=('Inter', 10), fg='#000000') # 改這裡
...
display_text, display_price= getProductInfo("02") # 改這裡
...
display_text, display_price= getProductInfo("03") # 改這裡
...
display_text, display_price= getProductInfo("04") # 改這裡
