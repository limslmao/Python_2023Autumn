...
titleimg = Image.open('image/logo_tree.png')
...
bannerimg = Image.open('image/banner.jpg')
...
p1numlabel.grid(row=4, column=1, sticky=W+E+N+S)
...
p2numlabel.grid(row=4, column=3, sticky=W+E+N+S)
...
p4numlabel.grid(row=4, column=7, sticky=W+E+N+S)
...
cartimg = Image.open('image/Shopping Cart.png')
